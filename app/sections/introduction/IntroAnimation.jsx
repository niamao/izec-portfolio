...
export function WelcomeAnimation({ profile }) {
	const isMobile = useMediaQuery();
	const ref = useRef(null);
	const isInView = useInView(ref, { once: true });
	const { theme, systemTheme } = useTheme();
	const colorMode = theme === "system" ? systemTheme : theme;
	const forDarkMode = profile?.arrow_color?.d_arrow_color || "#14b8a6"
	const forLightMode = profile?.arrow_color?.l_arrow_color || "#333"
	const arrowColor = colorMode === "dark" ?  forDarkMode : forLightMode;
		...
		>
			...
			>
				...
				<defs>
					...
					>
						<stop offset="0.333333" stopColor={arrowColor} />
